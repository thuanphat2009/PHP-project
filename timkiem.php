...
//show sp
$result_page = $product->show_productuser_pagein_search($tukhoa, $option, $startPro, $pro);
//lấy tất cả sp từ db
$rows = $product->show_productuser_all_search($tukhoa, $option);
        ...
        <div class="row">
            ...
            <div class="span9">
                ...
                <div class="tab-content">
                    ...
                    <?php } else { ?>
                        <h2 class="text-center text-danger">Không tìm thấy sản phẩm tương ứng</h2>
                    <?php } ?>
                ...
                <div class="pagination">
                    <ul>
                        <?php if ($page > 1) : ?>
                            <li><a href="timkiem.php?page=<?= $page - 1  ?>">&lsaquo;</a></li>
                        <?php endif; ?>

                        <?php for ($i = 1; $i <= $total; $i++) : ?>
                            <?php if ($page == $i) { ?>

                                <li><a class="" href="timkiem.php?page=<? $i ?>"><?php $i ?></a></li>

                            <?php } else { ?>

                                <li><a class="" href="timkiem.php?page=<?= $i ?>"><?= $i ?></a></li>
                        ...
                        <?php if ($page != $total) : ?>
                            <li><a href="timkiem.php?page=<?= $page + 1  ?>">&rsaquo;</a></li>
                        <?php endif; ?>
                    </ul>
                </div>
                <br class="clr" />
